...
//    oninit: function(vnode) {User.load(vnode.attrs.id)},
    view: function() {
        return m("form", {
            ...
            m("label.label", "Speciality"),
            m("input.input[placeholder=Speciality]", {
                oninput: m.withAttr("value", function(value) {Doctor.current.speciality = value}),
                value: Doctor.current.speciality
            }),
